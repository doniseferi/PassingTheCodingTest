...
public class BfsTests
{
    ...
    {
        var result = BreadthFirstSearch.Search_(_root, 5);
    ...
    {
        var result = BreadthFirstSearch.Search_(_root, 4);
    ...
    {
        Assert.Throws<KeyNotFoundException>(() => BreadthFirstSearch.Search_(_root, 10));
    }

    [Test]
    public void Test_FindLeftmostValue()
    {
        var result = BreadthFirstSearch.Search_(_root, 1);
    ...
    {
        var result = BreadthFirstSearch.Search_(_root, 7);
    ...
    public void Test_FindInSingleNodeTree()
    {
        ...
        var result = BreadthFirstSearch.Search_(singleNode, 1);
        Assert.That(result.Value, Is.EqualTo(1));
    }
    ...
    {
        var singleNode = new Node(1);
        Assert.Throws<KeyNotFoundException>(() => BreadthFirstSearch.Search_(singleNode, 2));
    }
}